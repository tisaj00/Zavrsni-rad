...
<body class="naslovna">
	<div class="container">
        ...
        <div class="col-lg-12 col-md-12 col-sm-12 col-xs-12 remove-padding">
            ...
            <h1>Kontrolna ploča admina unutar 24h</h1>
					</div>
          ...
          <?php
            ...
            $sql="SELECT username AS KORISNIK, city AS GRAD, city AS GRAD, contact AS MOJ_KONTAKT, adress AS MOJA_ADRESA,name AS IME , del_adress AS DESTINACIJA, date AS DATUM, pob AS PBROJ, price AS CIJENA FROM orders WHERE date >= now() - INTERVAL 1 DAY; ";
