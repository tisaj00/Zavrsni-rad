...
<body class="naslovna">
	<div class="container">
        ...
        <div class="col-lg-12 col-md-12 col-sm-12 col-xs-12 remove-padding">
            ...
            <h1>Kontrolna ploča vozača</h1>
					</div>

					<div class="col-lg-2 col-md-2 col-sm-2 col-xs-2 remove-padding">
            <a href="driver.php" class="btn btn-primary pull-right">Natrag</a>
					</div>
          ...
          <?php
            ...
            $sql="SELECT username AS KORISNIK, city AS GRAD, adress AS ADRESA, del_adress AS DESTINACIJA,name AS IME , pob AS PBROJ,date AS DATUM, price AS CIJENA FROM orders WHERE date >= now() - INTERVAL 1 DAY;";
